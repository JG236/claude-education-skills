...
## Domains 10–14: Extended Library Specification
*Added March 2026 — second build sprint. Read this section carefully before building any skill in Domains 10–14. These domains require more nuanced handling than Domains 1–9.*

---

### Critical Note for Domains 10–14

These domains require particular care around three issues:

**1. Evidence strength varies more than in Domains 1–9.** Some skills here draw on strong quantitative evidence (variation theory, CPA, lesson study). Others draw on strong qualitative or practitioner research traditions (Reggio, Ubuntu, place-based). Others are included because they represent original practitioner frameworks under active development (Domain 14). Be precise about which category each skill falls into. Use the `evidence_strength` field honestly: `strong`, `moderate`, or `emerging`. Never claim `strong` for qualitative-only evidence bases.

**2. Cultural framing matters enormously.** Several skills in Domains 10–11 draw on non-Western traditions. Do not flatten these into Western pedagogical language. Ubuntu is not just "collaborative learning." Place-based inquiry is not just "contextualised learning." The cultural and philosophical specificity is the point. Preserve it while making the skill practically usable.

**3. Domain 14 is explicitly labelled as practitioner frameworks, not peer-reviewed research.** The introduction to every Domain 14 skill must be honest about this. See the Domain 14 section below for exact framing language.

---

### Domain 10: Global & Cross-Cultural Pedagogies (9 skills)

*Core principle: These skills encode pedagogical approaches developed outside the Anglo-American research tradition that dominates Domains 1–9. The goal is not tokenism — each skill must meet the same inclusion criteria. The goal is honest recognition that high-quality pedagogy has been developed in many cultural contexts, and that the WEIRD bias in education research (Henrich et al.) means Western-only libraries systematically miss important knowledge.*

**Skills:**

1. **Variation Theory Task Designer** — designs tasks that systematically vary one critical feature while holding others constant, helping students discern the object of learning. *Evidence: Marton & Booth (1997) phenomenography, Marton & Pang (2006) variation theory, Lo (2012). Developed in Hong Kong and Sweden. Strong quantitative evidence base, especially in mathematics and science.*

2. **Concrete-Pictorial-Abstract Sequence Designer** — designs a three-phase instructional sequence moving from physical manipulation to visual representation to abstract notation. *Evidence: Singapore Mathematics Curriculum Framework, Bruner (1966) enactive-iconic-symbolic, extensive PISA performance data from Singapore. Particularly strong for mathematics. Effect sizes consistently high in Singapore research.*

3. **Phenomenon-Based Unit Anchor** — designs a real-world phenomenon as the organising anchor for an interdisciplinary unit, with inquiry questions that require multiple disciplines to investigate. *Evidence: Finnish POPS 2016 curriculum reform, Lonka et al. (2018) on phenomenon-based learning, Illeris (2009). Note: phenomenon-based learning is a curriculum organisation principle — the skill encodes how to design the anchor and inquiry structure, not the full unit.*

4. **Culturally Responsive Teaching Designer** — adapts a lesson or unit to explicitly build on students' cultural backgrounds, languages, and community knowledge as assets rather than deficits. *Evidence: Gay (2000, 2010) culturally responsive teaching, Ladson-Billings (1994, 2014) culturally relevant pedagogy, Paris (2012) culturally sustaining pedagogy. Strong qualitative evidence base; growing quantitative evidence especially for marginalised student populations.*

5. **Ubuntu Collective Knowledge Task Designer** — designs learning tasks grounded in Ubuntu philosophy (I am because we are), where knowledge is constructed collectively and the community is the unit of learning. *Evidence: Mkabela (2005), Msila (2008), Ubuntu philosophy of education literature. Qualitative evidence base. Note: Ubuntu is not simply "collaborative learning" — it carries specific philosophical commitments about the relational nature of knowledge and personhood. Preserve this specificity.*

6. **Place-Based Inquiry Anchor** — grounds academic learning in the specific place, community, ecology, and cultural history students inhabit. *Evidence: Castagno & Brayboy (2008) landmark review of culturally responsive schooling for Indigenous students, Sobel (2004), Smith (2002). Particularly strong evidence for engagement and cultural identity outcomes for Indigenous and marginalised students.*

7. **Reggio Documentation Protocol** — generates a structured observation and documentation protocol for making student learning visible through multiple media (photographs, transcripts, work samples, teacher notes). *Evidence: Rinaldi (2006), Malaguzzi's pedagogy of listening, Project Zero documentation research. Strong practitioner research base. Scoped to early childhood and primary contexts where evidence is strongest.*

8. **Emergent Project Design Scaffold** — designs the initial conditions for an emergent project: provocations, open questions, material invitations, and documentation checkpoints. *Evidence: Reggio Emilia approach (Rinaldi, Edwards, Gandini & Forman), Project Zero Visible Thinking. Practitioner research base. Note: emergent design means the project direction is not predetermined — the skill designs the conditions for emergence, not the project itself.*

9. **Cross-Cultural Task Validity Checker** — evaluates a learning task or assessment for cultural assumptions, language bias, and WEIRD bias, suggesting modifications to improve validity across cultural contexts. *Evidence: Henrich, Heine & Norenzayan (2010) on WEIRD bias, van de Vijver & Tanzer (2004) on cross-cultural assessment validity. This skill is a quality control tool, not a pedagogical approach.*

---

### Domain 11: Environmental & Experiential Learning (6 skills)

*Core principle: These skills encode pedagogical approaches that use the natural world, real communities, and direct experience as primary learning contexts. Evidence strength varies — outdoor learning has strong systematic review evidence; biophilic design is more emerging. Be precise.*

**Skills:**

1. **Outdoor Learning Sequence Designer** — designs a structured outdoor learning sequence with clear learning intentions, safety considerations, and indoor-outdoor continuity. *Evidence: Education Endowment Foundation systematic review (2019), Rickinson et al. (2004) review of outdoor learning, Scottish outdoor learning research. Effect sizes moderate but consistent for engagement and wellbeing outcomes.*

2. **Biophilic Learning Environment Designer** — redesigns a classroom or learning space to incorporate natural elements, natural light, living systems, and nature views. *Evidence: Kellert (2005, 2008) biophilic design, Wells (2000) on nature and attention restoration, Kaplan & Kaplan attention restoration theory. Emerging-to-moderate evidence base.*

3. **Ecological Inquiry Anchor Designer** — designs a local ecological question as the anchor for sustained scientific inquiry, connecting curriculum to the living systems students inhabit. *Evidence: Sobel (1996, 2004) place-based education, Orr (1992) ecological literacy. Qualitative evidence base. Particularly relevant to D2R regenerative entrepreneurship framing.*

4. **Experiential Learning Cycle Designer** — designs a four-phase experiential learning sequence: concrete experience → reflective observation → abstract conceptualisation → active experimentation. *Evidence: Note — Kolb's (1984) learning cycle is widely cited but has weaker empirical validation than its ubiquity suggests. This skill draws additionally on simulation-based learning research (Hattie effect size 0.33) and service learning (Billig 2000) which have stronger evidence. Flag Kolb's limitations honestly in Known Limitations.*

5. **Interdisciplinary Real-World Connection Mapper** — maps the connections between a real-world problem or project and the disciplinary knowledge required to address it, generating a curriculum integration plan. *Evidence: Barron & Darling-Hammond (2008), Drake & Burns (2004) on integrated curriculum. Moderate evidence base, particularly for PBL contexts.*

6. **Service Learning Project Designer** — designs a service learning project with genuine community benefit, curriculum alignment, structured reflection, and assessment criteria. *Evidence: Billig (2000, 2004) service learning research, RMC Research Corporation reviews. Effect sizes moderate; strongest effects when reflection is structured and community partnership is genuine.*

---

### Domain 12: AI Learning Science (7 skills)

*Core principle: These skills encode research from intelligent tutoring systems, adaptive learning, and the cognitive science of human-AI interaction in learning contexts. This domain is directly relevant to Kaku's architecture. It is the most technically specialised domain in the library.*

**Skills:**

1. **Adaptive Hint Sequence Designer** — designs a cascading hint sequence for a specific problem type, where hints progressively reveal more information without giving away the answer. *Evidence: VanLehn (2011) meta-analysis of intelligent tutoring systems (effect size 0.76), Aleven & Koedinger (2002) on hint-seeking behaviour. The hint sequence is one of the most technically demanding aspects of ITS design — getting it wrong produces either frustration or answer-giving.*

2. **Erroneous Example Designer** — designs worked examples that contain deliberate, common errors for students to identify and correct. *Evidence: McLaren et al. (2012, 2015) erroneous examples research, Tsovaltzi et al. (2010). Effect sizes comparable to correct worked examples, with additional benefit of error detection training. Note: errors must be realistic and common — invented errors are less effective.*

3. **Digital Worked Example Sequence** — designs a worked example sequence optimised for digital delivery: pacing, self-explanation prompts, fading schedule, and interactivity design. *Evidence: Sweller et al. (2019) updated cognitive load theory for digital contexts, Renkl (2014) on worked examples in digital environments, Atkinson et al. (2000).*

4. **Individual Spacing Algorithm Explainer** — generates a personalised spaced repetition schedule for a specific student based on their performance data, explaining the algorithm logic in teacher-friendly terms. *Evidence: Lindsey et al. (2014) on adaptive spacing, Duolingo spacing research (Settles & Meeder 2016), Ebbinghaus forgetting curve. Note: this skill explains and designs the algorithm — it does not execute it. Execution requires a system like Hippo.*

5. **AI Feedback Design Principles** — evaluates a proposed AI feedback design against research criteria for effective automated feedback, suggesting improvements. *Evidence: Shute (2008) formative feedback review, Narciss (2008) on informative tutoring feedback, growing literature on LLM feedback quality (Dai et al. 2023). Distinguishes between verification feedback (correct/incorrect), elaborated feedback (why), and strategic feedback (what to do next).*

6. **Intelligent Tutoring Dialogue Designer** — designs the dialogue logic for an AI tutoring interaction: when to prompt, when to give hints, when to explain, when to stay silent. *Evidence: VanLehn (2011), Chi et al. (2001) on self-explanation and tutoring, Graesser et al. (2005) AutoTutor research. The hardest design problem in ITS: too much intervention prevents productive struggle; too little leaves students stuck.*

7. **Learning Analytics Interpretation Guide** — guides a teacher through interpreting a specific learning dataset (assessment results, engagement data, study behaviour patterns) to identify actionable patterns. *Evidence: Siemens & Long (2011) on learning analytics, Bienkowski et al. (2012) DoE report, Wiliam (2011) on data use for formative purposes. Note: learning analytics is only useful if it changes teacher decisions — this skill focuses on the decision, not the data.*

---

### Domain 13: Montessori & Alternative Evidence-Based Approaches (4 skills)

*Core principle: Montessori has a genuine and growing evidence base, particularly for executive function and early literacy/mathematics. Include only practices with specific empirical validation — not Montessori philosophy generally.*

**Skills:**

1. **Three-Part Lesson Designer (Montessori)** — designs a three-phase lesson: introduction (naming), recognition ("show me"), recall (naming by student). *Evidence: Lillard et al. (2006) Science paper on Montessori outcomes, Lillard (2012) follow-up research. The three-part lesson is the most encodable and most studied Montessori instructional practice.*

2. **Prepared Environment Designer** — evaluates and redesigns a classroom environment using Montessori prepared environment principles: accessibility, order, beauty, real materials, child scale. *Evidence: Lillard (2005) Montessori: The Science Behind the Genius, Cossentino (2006). Moderate evidence base — environment design effects are harder to isolate than instructional effects.*

3. **Mixed-Age Learning Task Designer** — designs a task that productively uses mixed-age groupings, with roles for older students as teachers and younger students as learners. *Evidence: Lillard et al. (2006), peer tutoring research (Hattie effect size 0.55), Vygotsky ZPD applied to age mixing. Strong theoretical and moderate empirical support.*

4. **Uninterrupted Work Cycle Designer** — designs a 3-hour uninterrupted work period with materials rotation, teacher observation protocol, and transition management. *Evidence: Lillard (2005), time-on-task research (Rosenshine), flow state literature (Csikszentmihalyi). Note: the 3-hour work cycle is central to Montessori but challenging to implement in standard school timetables — Known Limitations must address this honestly.*

---

### Domain 14: D2R, SEEDS & Gareth's Original Frameworks (8 skills)

*Core principle: These skills are explicitly different from all other domains. They encode original practitioner frameworks developed by Gareth Manning at REAL School Budapest. They do not have peer-reviewed validation. They are included because:*
*1. They represent serious, carefully designed curriculum work being actively tested in real classrooms.*
*2. The skill library is designed to support their implementation.*
*3. The underlying logic is transferable to other contexts.*

**Every skill in this domain must begin its "What This Skill Does" section with this statement:**
...
**This is not weakness — it is intellectual integrity.**

**Skills:**

*Note: Domain 14 requires a dedicated briefing session with Gareth Manning before Claude Code builds these skills. The frameworks need to be described precisely — do not approximate or infer from names alone. Wait for the briefing session.*

1. **7-Stage D2R Project Cycle Designer** — *Requires briefing: exact stages, pedagogical logic of progression, what teachers/students do at each stage, how competencies map to stages.*

2. **SEEDS Observation & Documentation Protocol** — *Requires briefing: what SEEDS stands for, how it works in practice, what it produces, which learning groups it applies to.*

3. **Developmental Band Competency Designer** — *Requires briefing: the four-band structure, the logic of developmental progression across bands, how bands relate to age/grade levels, the 9-level literacy/maths exception and why.*

4. **Curriculum Outcome Decomposition Tool** — *Requires briefing: the specific logic for breaking curriculum outcomes into developmental competencies, what makes this decomposition coherent rather than arbitrary.*

5. **Coherent Rubric Logic Builder** — *Requires briefing: what makes Gareth's rubric structure coherent in ways standard rubric design isn't, the specific logic of level descriptors.*

6. **D2R Assessment Evidence Mapper** — *Requires briefing: how competencies map to project evidence, what counts as evidence, how teachers document it.*

7. **Habit Design Curriculum Sequence** — *Requires briefing: the specific curriculum Gareth has built for Strive, the pedagogical sequence for teaching students to design, track, and reflect on habits, the evidence base he draws on (Clear, Duhigg, Gollwitzer, Lally).*

8. **Competency Framework to Developmental Band Mapper** — *Requires briefing: how Gareth mapped EU frameworks (GreenComp, EntreComp, LifeComp, DigComp) and UNESCO AI competencies to his four developmental bands, the logic of that mapping.*

---

### Supporting Files to Build After All 14 Domains

Build these last, once all skills exist and the full scope is visible:

1. **README.md** (replace placeholder) — leads with "works right now, any teacher with Claude can use this today." Shows a quick example. Lists all domains. Treats three-layer architecture as vision not prerequisite. Names Gareth Manning clearly — this is a credibility asset not a vanity claim.

2. **ARCHITECTURE.md** (revise existing) — reframe from "incomplete system" to "composable and extensible." The library works standalone today. The context engine and orchestrator are the future it's designed for.

3. **IMPLEMENTATIONS.md** (new) — "These skills are being actively implemented through the following tools." Strive (habit design pedagogy), Hippo (retrieval practice and spaced repetition), Ren (personal self-regulation, informed the implementation intention and affect regulation skills), Kaku (the full three-layer system under development).

4. **CONTRIBUTING.md** (new) — inclusion criteria for external contributors. All three criteria must be met. Explicit list of what will be rejected (see exclusion list). Review process.

5. **MCP server** (new repository: `claude-education-skills-mcp`) — exposes the skill library as callable Claude tools using the YAML schemas as tool definitions. Open source, MIT licence. See mcp-builder skill guide for implementation approach.
